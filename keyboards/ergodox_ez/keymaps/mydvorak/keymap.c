...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_DELETE,      MT(MOD_LCTL, KC_SCOLON),MT(MOD_LALT, KC_COMMA),MT(MOD_LCTL, KC_DOT),KC_P,    KC_Y,           TT(1),                                          TT(1),          KC_F,           KC_G,           KC_C,           KC_R,           KC_L,           MT(MOD_LGUI, KC_SLASH),
    MT(MOD_LALT, KC_MINUS),KC_A,           KC_O,           KC_E,           KC_U,           KC_I,                                                                           KC_D,           KC_H,           KC_T,           KC_N,   KC_S,           MT(MOD_LALT, KC_BSLASH),
